...
export class No {
    ...
    filhos(problema) {
        ...
        if (!estado_acoes) return [];
        return estado_acoes.acoes.map(a => new No(a.destino, this.custo + a.custo, this, a.destino));
    }
